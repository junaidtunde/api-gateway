...
for f in ./node_modules/@autochek-africa/proto/proto/*; do
  ...
  ${GRPC_TOOLS_NODE_PROTOC} \
      ...
      --swagger_out=allow_delete_body=true,logtostderr=true:"${swagger_doc}" \
      --proto_path="./node_modules/@autochek-africa/proto/proto/" \
